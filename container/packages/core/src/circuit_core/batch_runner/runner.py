...
from circuit_core.batch_runner.manifest import Manifest, ScenarioDef
from circuit_core.batch_runner.parallel import WorkItem, WorkResult, run_layer1_parallel
...
def run_batch(
    ...
    from circuit_core.data_loader.tools.load import run_load
    ...
    from circuit_core.data_loader.tools.clean import run_clean_dataset
    ...
    from circuit_core.data_loader.tools.batch_create import run_create_segments
...
def _apply_normalization(manifest: Manifest) -> None:
    ...
    import circuit_core.data_loader.storage as storage
    ...
    db = backend._conn
    dataset_table = f'"{manifest.dataset_name}"'
