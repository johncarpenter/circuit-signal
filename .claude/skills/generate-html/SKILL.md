...
| `--output` | Output folder path (default: workspace/outputs/exports/<filename>/) |
...
```
workspace/outputs/exports/proposal/
├── index.html
├── style.css
└── logo.svg
```
...
if 'output' in options:
    ...
    output_dir = BASE_DIR / "workspace/outputs/exports" / md_path.stem
...
def export_to_html(
    ...
    **options
    ...
    if output_dir:
        ...
        out_dir = BASE_DIR / "workspace/outputs/exports" / md_path.stem
